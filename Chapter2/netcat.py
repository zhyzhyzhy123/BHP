...
class NetCat:
    def __init__(self, args, buffer=None):
        ...
        self.socket.setsockopt(socket.SOL_SOCKET, socket.SO_REUSEADDR, 1) #3
    ...
    def send(self):
        self.socket.connect((self.args.target, self.args.port)) #5
        if self.buffer:
    ...
    def listen(self):
        self.socket.bind((self.args.target, self.args.port)) #6
